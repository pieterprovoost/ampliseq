...
- [#1026](https://github.com/nf-core/ampliseq/pull/1026),[#1046](https://github.com/nf-core/ampliseq/pull/1046),[#1049](https://github.com/nf-core/ampliseq/pull/1049) - Add support for Oxford Nanopore Technology (ONT) R10.4 sequencing (preferably with SUP basecalling) with Savont (by @d4straub)
...
- [#XXXX](https://github.com/nf-core/ampliseq/pull/XXXX) - VSEARCH LCA now also publishes the raw `--blast6out` hit table (`ASV_tax_vsearch_lca.*.txt` / `ASV_ITS_tax_vsearch_lca.*.txt`) alongside the existing LCA and taxonomy TSV outputs (by @pieterprovoost)
...
- [#957](https://github.com/nf-core/ampliseq/pull/957),[#979](https://github.com/nf-core/ampliseq/pull/979) - Added ITSxRust as an optional alternative to ITSx for ITS region extraction via `--its_extractor itsxrust`.
...
- [#981](https://github.com/nf-core/ampliseq/pull/981) - Standardized sample sheet column names to match nf-core conventions (legacy sample sheet is still valid)
...
- [#983](https://github.com/nf-core/ampliseq/pull/983),[#985](https://github.com/nf-core/ampliseq/pull/985) - Update documentation

### `Fixed`

- [#952](https://github.com/nf-core/ampliseq/pull/952) - Ensure paired FASTQ files stay aligned by generating reverse paths from forward files instead of sorting independently
...
- [#989](https://github.com/nf-core/ampliseq/pull/989) - Execute downstream analysis when using `--classifier`.
...
- [#978](https://github.com/nf-core/ampliseq/pull/978) - `--illumina_novaseq` (boolean) was replaced by `--binned_quality` (string)
